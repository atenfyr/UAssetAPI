...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PropertyData](./uassetapi.propertytypes.objects.propertydata.md) → [PropertyData&lt;UInt32&gt;](./uassetapi.propertytypes.objects.propertydata-1.md) → [MaterialInputPropertyData&lt;UInt32&gt;](./uassetapi.propertytypes.structs.materialinputpropertydata-1.md) → [ShadingModelMaterialInputPropertyData](./uassetapi.propertytypes.structs.shadingmodelmaterialinputpropertydata.md)<br>
