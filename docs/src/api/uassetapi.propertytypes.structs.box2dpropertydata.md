...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PropertyData](./uassetapi.propertytypes.objects.propertydata.md) → [PropertyData&lt;Vector2DPropertyData[]&gt;](./uassetapi.propertytypes.objects.propertydata-1.md) → [Box2DPropertyData](./uassetapi.propertytypes.structs.box2dpropertydata.md)<br>
