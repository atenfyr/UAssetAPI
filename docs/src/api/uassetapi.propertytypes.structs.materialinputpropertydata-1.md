...
```csharp
public abstract class MaterialInputPropertyData<T> : , System.ICloneable
```
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PropertyData](./uassetapi.propertytypes.objects.propertydata.md) → PropertyData&lt;T&gt; → [MaterialInputPropertyData&lt;T&gt;](./uassetapi.propertytypes.structs.materialinputpropertydata-1.md)<br>
...
### **MaterialInputPropertyData(FName)**

```csharp
public MaterialInputPropertyData(FName name)
```
...
### **WriteExpressionInput(AssetBinaryWriter, Boolean)**
