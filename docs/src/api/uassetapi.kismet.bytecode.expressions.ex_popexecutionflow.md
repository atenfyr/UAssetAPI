...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [KismetExpression](./uassetapi.kismet.bytecode.kismetexpression.md) → [EX_PopExecutionFlow](./uassetapi.kismet.bytecode.expressions.ex_popexecutionflow.md)<br>
