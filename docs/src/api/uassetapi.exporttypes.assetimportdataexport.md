# AssetImportDataExport

Namespace: UAssetAPI.ExportTypes

```csharp
public class AssetImportDataExport : NormalExport, System.ICloneable
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Export](./uassetapi.exporttypes.export.md) → [NormalExport](./uassetapi.exporttypes.normalexport.md) → [AssetImportDataExport](./uassetapi.exporttypes.assetimportdataexport.md)<br>
...
### **AssetImportDataExport(Export)**

```csharp
public AssetImportDataExport(Export super)
```
...
### **AssetImportDataExport(UAsset, Byte[])**

```csharp
public AssetImportDataExport(UAsset asset, Byte[] extras)
```
