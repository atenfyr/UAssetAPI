...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [KismetExpression](./uassetapi.kismet.bytecode.kismetexpression.md) → [EX_LetBool](./uassetapi.kismet.bytecode.expressions.ex_letbool.md)
