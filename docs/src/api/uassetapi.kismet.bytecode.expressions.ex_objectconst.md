...
```csharp
public class EX_ObjectConst : UAssetAPI.Kismet.Bytecode.KismetExpression`1[[UAssetAPI.UnrealTypes.FPackageIndex, UAssetAPI, Version=1.0.1.0, Culture=neutral, PublicKeyToken=null]]
```
