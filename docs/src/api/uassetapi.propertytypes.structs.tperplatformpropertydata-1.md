...
```csharp
public abstract class TPerPlatformPropertyData<T> : , System.ICloneable
```
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PropertyData](./uassetapi.propertytypes.objects.propertydata.md) → PropertyData&lt;T[]&gt; → [TPerPlatformPropertyData&lt;T&gt;](./uassetapi.propertytypes.structs.tperplatformpropertydata-1.md)<br>
...
### **TPerPlatformPropertyData(FName)**

```csharp
public TPerPlatformPropertyData(FName name)
```
