...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PropertyData](./uassetapi.propertytypes.objects.propertydata.md) → [PropertyData&lt;FFontData&gt;](./uassetapi.propertytypes.objects.propertydata-1.md) → [FontDataPropertyData](./uassetapi.unrealtypes.fontdatapropertydata.md)<br>
