...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [JmapObjectBase](./uassetapi.unversioned.jmapobjectbase.md) → [JmapStruct](./uassetapi.unversioned.jmapstruct.md)
