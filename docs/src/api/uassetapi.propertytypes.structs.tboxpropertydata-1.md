...
```csharp
public abstract class TBoxPropertyData<T> : , System.ICloneable
```
...
Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [PropertyData](./uassetapi.propertytypes.objects.propertydata.md) → PropertyData&lt;TBox&lt;T&gt;&gt; → [TBoxPropertyData&lt;T&gt;](./uassetapi.propertytypes.structs.tboxpropertydata-1.md)<br>
...
### **TBoxPropertyData(FName)**

```csharp
public TBoxPropertyData(FName name)
```
