...
```csharp
public class EX_FieldPathConst : UAssetAPI.Kismet.Bytecode.KismetExpression`1[[UAssetAPI.Kismet.Bytecode.KismetExpression, UAssetAPI, Version=1.0.1.0, Culture=neutral, PublicKeyToken=null]]
```
