# ActorComponentExport

Namespace: UAssetAPI.ExportTypes

```csharp
public class ActorComponentExport : NormalExport, System.ICloneable
```

Inheritance [Object](https://docs.microsoft.com/en-us/dotnet/api/system.object) → [Export](./uassetapi.exporttypes.export.md) → [NormalExport](./uassetapi.exporttypes.normalexport.md) → [ActorComponentExport](./uassetapi.exporttypes.actorcomponentexport.md)<br>
...
### **ActorComponentExport(Export)**

```csharp
public ActorComponentExport(Export super)
```
...
### **ActorComponentExport(UAsset, Byte[])**

```csharp
public ActorComponentExport(UAsset asset, Byte[] extras)
```
