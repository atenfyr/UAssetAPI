...
{
    public class IOStoreBinaryWriter : BinaryWriter
    {
        public IOStoreContainer Asset;

        public IOStoreBinaryWriter(IOStoreContainer asset) : base()
        {
            Asset = asset;
        }

        public IOStoreBinaryWriter(Stream stream, IOStoreContainer asset) : base(stream)
        {
            Asset = asset;
        }

        public IOStoreBinaryWriter(Stream stream, Encoding encoding, IOStoreContainer asset) : base(stream, encoding)
        {
            Asset = asset;
        }

        public IOStoreBinaryWriter(Stream stream, Encoding encoding, bool leaveOpen, IOStoreContainer asset) : base(stream, encoding, leaveOpen)
        {
            Asset = asset;
        }
